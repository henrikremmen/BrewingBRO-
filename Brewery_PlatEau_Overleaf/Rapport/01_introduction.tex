...
\IEEEPARstart{B}{rewery} Plat-Eau is an optimisation project about choosing how to produce beer at minimum cost. The model decides how much barley, malt, malt extract, hops, and yeast to use for a requested beer volume and colour. Later tasks also require minimum ingredient quality.
